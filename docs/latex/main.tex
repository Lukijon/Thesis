...
\textbf{Dois casos concretos.} WEG (2015$\to$2016, similaridade 0,9915) é um exemplo de similaridade genuinamente alta: a estrutura da nota é praticamente idêntica entre os dois anos, apenas valores e data mudam, o padrão de ``boilerplate atualizado com novos números''. Já a Yduqs (2015--2019, similaridade exatamente 1,0000 em quatro pares seguidos) é um exemplo de falha de extração: o localizador capturou por engano, nesses anos, um parágrafo genérico de política contábil em vez da nota real. Todo escore degenerado (exatamente 0 ou 1) inspecionado neste projeto rastreou até uma falha de extração conhecida, não até uma falha da própria medida de similaridade.
