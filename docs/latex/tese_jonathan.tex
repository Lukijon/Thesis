...
\begin{table}[htbp]
    ...
    \begin{tabular}{@{}llrr@{}}
        ...
        Nota de dívida isolada (total)      & Trimestral & [ITR em aquisição] & -- \\
        Nota de dívida isolada (confiável)  & Trimestral & [ITR em aquisição] & -- \\
...
\begin{table}[htbp]
    ...
    \begin{tabular}{@{}lrrrrr@{}}
        ...
        Nota de dívida (trimestral)  & [ITR em aquisição] & -- & -- & \cellcolor{m2principal}-- & -- \\
...
\begin{table}[htbp]
    ...
    \begin{tabular}{@{}llrrrr@{}}
        ...
        Nota de dívida (trimestral) & \multicolumn{5}{l}{[em aquisição -- ver Seção~\ref{sec:amostra}]} \\
    ...
    \end{tabular}
    \\[0.3cm]
    {\footnotesize Fonte: elaborada pelo autor. EP = erro-padrão agrupado por empresa. *M2 é a especificação principal. Nota de dívida (anual): amostra restrita a pares com extração confiável (Seção~\ref{sec:confiabilidade}); único bloco de linhas cujo intervalo de confiança não contém zero em nenhum modelo da grade. Nota de dívida (trimestral): aquisição do ITR para o universo expandido ainda em andamento no momento do fechamento desta versão.}
\end{table}
