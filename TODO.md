...
- [x] **Dados de mercado: preços e retornos das ações** — ✅ recebido (verificado)
  ...
  - Ainda falta confirmar se as 45 empresas históricas (fora das 66 atuais) estão todas cobertas pelos 87 tickers "extra" — não fiz esse cruzamento fino ainda, ficar atento na etapa de cálculo de retorno anormal.
